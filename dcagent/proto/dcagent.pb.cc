...
void protobuf_AssignDesc_dcagent_2eproto() {
  protobuf_AddDesc_dcagent_2eproto();
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_dcagent_2eproto);
}
...
void protobuf_AddDesc_dcagent_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\rdcagent.proto\022\006dagent\"+\n\tMsgDAgent\022\014\n\004"
    "type\030\001 \002(\005\022\020\n\010msg_data\030\002 \001(\014", 68);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "dcagent.proto", &protobuf_RegisterTypes);
  MsgDAgent::default_instance_ = new MsgDAgent();
  MsgDAgent::default_instance_->InitAsDefaultInstance();
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_dcagent_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_dcagent_2eproto {
  StaticDescriptorInitializer_dcagent_2eproto() {
    protobuf_AddDesc_dcagent_2eproto();
  }
} static_descriptor_initializer_dcagent_2eproto_;
...
const MsgDAgent& MsgDAgent::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_dcagent_2eproto();
