...
//1. flat buffer
//2. template type
//3. dynamic allocation (save space)
...
namespace dcsutil {
    ...
    struct hashmap_t;
    //////////////////////static/////////////////////////////////
    struct QuotaStrategyBitmap;
    struct QuotaStrategyFreeList;
    template<class T, size_t count, class M, class QuotaStrategy>
    struct BlockArray;
    template<class T, size_t count, class M, class QuotaStrategy>
    struct BlockArray;
    template<class P, size_t count, size_t layer>
    struct HashTable;
    ///////////////////////////////////////////////////////////////////////
